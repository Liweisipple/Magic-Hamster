...
function optionsframework_init() {
	...
	require plugin_dir_path( __FILE__ ) . 'includes/framework.php';
	require plugin_dir_path( __FILE__ ) . 'includes/framework-admin.php';
	require plugin_dir_path( __FILE__ ) . 'includes/interface.php';
	require plugin_dir_path( __FILE__ ) . 'includes/media-uploader.php';
	require plugin_dir_path( __FILE__ ) . 'includes/sanitization.php';
	...
	wp_enqueue_style( 'optionsframework', OPTIONS_FRAMEWORK_DIRECTORY.'css/admin.css' );
}
