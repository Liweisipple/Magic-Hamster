...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( '主题选项', 'textdomain'),
			'menu_title' => __('主题选项', 'textdomain'),
     ...
     */
	 function options_page() { ?>
		...
		<h2><div class="dashicons dashicons-admin-settings"></div><?php echo esc_html( $menu['page_title'] ); ?><span class="version"><?php $my_theme = wp_get_theme(); echo "版本 " . $my_theme->get( 'Version' ); ?></span><span style="border-radius: 4px; color: #fff; font-size: 13px; cursor: pointer; background: #FC5C7D;"> 主机推荐：<a href="http://www.thefox.cn/url/aliyun" target="_blank">阿里云优惠券</a>，<a href="http://www.thefox.cn/url/aliyun-sell" target="_blank">全民云特惠330元/年</a></p><iframe id="lensnews" src="http://www.thefox.cn/begin.shtml" frameborder="0" style="display:none"></iframe></span></h2>
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认', 'textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '提示：点击确定，任何主题设置都将丢失！', 'textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '已恢复默认设置', 'textdomain' ), 'updated fade' );
