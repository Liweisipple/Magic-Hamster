...
<?php if ( is_home() || is_front_page() ) { ?><title><?php bloginfo('name'); ?><?php if (zm_get_option('blog_info')) { ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('description'); ?><?php } ?><?php if (get_query_var('paged')) { echo ' - 第';  echo get_query_var('paged'); echo '页';}?></title><?php } ?>
<?php } else { ?>
<?php if ( is_home() || is_front_page() ) { ?><title><?php echo zm_get_option('home_title'); ?><?php if (zm_get_option('home_info')) { ?> <?php echo zm_get_option('connector'); ?> <?php echo zm_get_option('home_info'); ?><?php } ?><?php if (get_query_var('paged')) { echo ' - 第';  echo get_query_var('paged'); echo '页';}?></title><?php } ?>
<?php } ?>
...
<?php if ( is_page() && !is_front_page() ) { ?><title><?php if ( get_post_meta($post->ID, 'custom_title', true) ) { ?><?php echo trim(get_post_meta($post->ID, 'custom_title', true)); ?><?php } else { ?><?php echo trim(wp_title('',0)); ?><?php } ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
...
<?php else: ?>
<?php if ( is_category() ) { ?><title><?php single_cat_title(); ?><?php if (get_query_var('paged')) { echo ' - 第'; echo get_query_var('paged'); echo '页';}?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php endif; ?>
...
<?php if ( is_author() ) { ?><title><?php the_author(); ?>发表的所有文章 <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
...
<?php if ( is_tag() ) { ?><title><?php echo get_option( 'tag-title-'.$term_id ); ?><?php if (get_query_var('paged')) { echo ' - 第'; echo get_query_var('paged'); echo '页';}?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php else: ?>
<?php if (function_exists('is_tag')) { if ( is_tag() ) { ?><title><?php  single_tag_title("", true); ?><?php if (get_query_var('paged')) { echo ' - 第'; echo get_query_var('paged'); echo '页';}?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?><?php } ?>
<?php endif; ?>
...
<?php if ( is_tax('gallerytag') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('videos') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('videotag') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('taobao') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('taotag') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('product_cat') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('product_tag') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if (function_exists( 'is_shop' )) { ?><?php if ( is_shop('')) { ?><title><?php echo trim( wp_title( '',0 ) ); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?><?php } ?>
<?php if ( is_tax('download_category') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('download_tag') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('dwqa-question_category') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('dwqa-question_tag') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if ( is_tax('favorites') ) { ?><title><?php setTitle(); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?>
<?php if (function_exists( 'is_bbpress' )) { ?><?php if ( is_bbpress()) { ?><title><?php the_title();?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?><?php } ?>
