...
<div id="fep-posts">
	...
	<ul>
		<li><a <?php if ($status == 'publish'): ?>class="active"<?php endif; ?>
			   href="?fep_type=publish">已发表</a></li>
		<li><a <?php if ($status == 'pending'): ?>class="active"<?php endif; ?>
			   href="?fep_type=pending">待审核</a></li>
	</ul>
	<div id="fep-post-table-container">
		...
		<div class="fep-nav">
			<?php if ($new_exist): ?>
				<a class="fep-nav-link fep-nav-link-left" href="?fep_type=<?= $status ?>&fep_page=<?= ($paged - 1) ?>">&#10094; 上页</a>
			<?php endif; ?>
			<?php if ($old_exist): ?>
				<a class="fep-nav-link fep-nav-link-right" href="?fep_type=<?= $status ?>&fep_page=<?= ($paged + 1) ?>">下页&#10095;</a>
			<?php endif; ?>
