...
<div id="button_box">
	<div id="button_file">
		<h3>文件下载</h3>
			...
			<a href="<?php echo $url1; ?>" rel="external nofollow" target="_blank"><i class="fa fa-cloud-download"></i> <?php echo $button1; ?></a>
			<?php endif; ?>
			...
			<a href="<?php echo $url2; ?>" rel="external nofollow" target="_blank"><i class="fa fa-cloud-download"></i> <?php echo $button2; ?></a>
			<?php endif; ?>
			...
			<a href="<?php echo $url3; ?>" rel="external nofollow" target="_blank"><i class="fa fa-cloud-download"></i> <?php echo $button3; ?></a>
			<?php endif; ?>
			...
			<a href="<?php echo $url4; ?>" rel="external nofollow" target="_blank"><i class="fa fa-cloud-download"></i> <?php echo $button4; ?></a>
			<?php endif; ?>
