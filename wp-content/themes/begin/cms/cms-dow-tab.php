<div class="img-tab-site wow fadeInUp" data-wow-delay="0.5s">
	<div id="img-tab" class="img-tab-product">
		...
		<div class="img-tab-bd img-dom-display">
			...
			<div class="img-tab-bd-con img-current">
				...
				?>
				<article id="post-<?php the_ID(); ?>" class="w4 x4 wow fadeInUp" data-wow-delay="0.3s">
					<div class="picture">
