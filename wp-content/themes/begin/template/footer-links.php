...
<div class="links-box">
	<div id="links">
		<?php if (zm_get_option('footer_img')) { ?>
			<ul><?php wp_list_bookmarks('title_li=&before=<li class="lx7"><span class="link-f link-img">&after=</span></li>&categorize=1&show_images=1&orderby=rating&order=DESC&category='.zm_get_option('link_f_cat')); ?></ul>
		<?php } else { ?>
