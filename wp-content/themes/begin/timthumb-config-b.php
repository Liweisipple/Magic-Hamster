...
if(! defined('ALLOW_ALL_EXTERNAL_SITES') )      define ('ALLOW_ALL_EXTERNAL_SITES', true);                             // 改为“false”则只允许裁剪指定顶级域名的外链接图片
...
if(! defined('FILE_CACHE_PREFIX') )             define ('FILE_CACHE_PREFIX', 'begin');                               // What to put at the beg of all files in the cache directory so we can identify them
...
class timthumb {
        ...
        public function __construct(){
                ...
                $cachePrefix = ($this->isURL ? '_img_' : '_int_');
                if($this->isURL){
