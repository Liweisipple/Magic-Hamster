							...
							<div class="brief">
								...
								<?php if ( get_post_meta($post->ID, 'discount', true) ) : ?>
									<?php
										...
										echo "<span class='discount'><a href='".get_template_directory_uri()."/inc/go.php?url=$url' rel='external nofollow' target='_blank' class='url'>$discount</a></span>";
									 ?>
								<?php endif; ?>

								<?php
									$url = get_post_meta($post->ID, 'taourl', true);
									echo "<span class='taourl'><a href='".get_template_directory_uri()."/inc/go.php?url=$url' rel='external nofollow' target='_blank' class='url'>直接购买</a></span>";
								 ?>
